The application simulates the front-end of a server application connected to a rasberry-pi that generates temperature and humidity values based on its sensors. 
